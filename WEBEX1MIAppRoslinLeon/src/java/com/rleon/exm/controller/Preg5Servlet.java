...
import com.rleon.exm.model.Platos;
import com.rleon.exm.model.Plato;
 ...
 * @author RLEON
 */
@WebServlet(name = "Preg5Servlet", urlPatterns = {"/Preg5"})
public class Preg5Servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet Preg5Servlet</title>");            
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet Preg5Servlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("preg5.jsp").forward(request, response);
